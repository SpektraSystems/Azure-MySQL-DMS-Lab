...
1.	Developing apps with Azure Database for PostgreSQL
Start Lab
...
5.	To launch the Azure Cloud Shell, click the Cloud Shell button on the menu in the top menu bar of the Azure portal.
...
11.	A server contains a group of databases. You can create an Azure Database for PostgreSQL server using the az postgres server create command.
...
<copy>create database bootcamp;</copy>
...
<copy>az vm create --resource-group <inject story-id="story://Content-Private/content/dfd/SP-OSS/postgresql/ossexperience1/story_a_postgresql" key="resourceGroupName" copy="false" /> --name myubuntu --vnet-name myvnet --image ubuntults --generate-ssh-keys</copy>
2.	Hit Enter
...
<copy>az vm open-port --port 8000 --resource-group <inject story-id="story://Content-Private/content/dfd/SP-OSS/postgresql/ossexperience1/story_a_postgresql" key="resourceGroupName" copy="false" /> --name myubuntu</copy>
4.	Hit Enter
5.	Connect to the VM using SSH in the Azure CLI
<copy>ssh [publicIpAddress]</copy>
...
<copy>sudo apt install python3-pip</copy>
...
<copy>git clone https://github.com/vitorfs/bootcamp.git </copy>
...
<copy>psql --host=pqsql<inject story-id="story://Content-Private/content/dfd/SP-OSS/postgresql/ossexperience1/story_a_postgresql" key="resourceGroupName" copy="false" />.postgres.database.azure.com --port=5432 --username=pgsqluser@pqsql<inject story-id="story://Content-Private/content/dfd/SP-OSS/postgresql/ossexperience1/story_a_postgresql" key="resourceGroupName" copy="false" /> --dbname=bootcamp </copy>
...
<copy>SELECT * FROM feeds_feed;</copy>
