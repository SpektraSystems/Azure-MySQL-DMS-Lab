...
```
16.	Now we need to configure the local git repository to know about the website. To do this we will add a new remote to the repository. Change the username value which you have in step 13 and webapp name which you just created.Also replace uniquename with webapp name.
```
